...
const LoginForm = lazy(() => import("./features/auth/components/SignUpCard/LoginForm.tsx"));
const RegisterForm = lazy(() => import("./features/auth/components/SignUpCard/RegisterForm.tsx"));
